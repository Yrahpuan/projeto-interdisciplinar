...
db.run("CREATE TABLE login(cpf char(11) not null, nome_de_usuario varchar(100) not null, senha varchar(100) not null, cargo varchar(100) not null, primary key(cpf));");
